...
//-----------------------------------------------------------------------------
	...
	struct a3_DemoState
	{
		...
		// not in physics world: object sizes and planar normals
		a3mat4 groundScale, anchorScale, rampScale, particleScale;
		...
		union {
			...
			struct {
				a3_DemoSceneObject
					...
					// kinematic physics objects: 
					groundObject[1],
					springAnchorObject[1],
					springAnchorOtherObject[1],
					rampStationaryObject[1],
					rampTiltingObject[1],
					rampRotatingObject[1],

					// particles: 
					vacuumBowlingBallObject[1],
					vacuumFeatherObject[1],
					normalBowlingBallObject[1],
					normalFeatherObject[1],
					draggingObject[1],
					bouncyObject[1],
					lessBouncyObject[1],
					springyObject[1],
					springyOtherObject[1],
					rampyObject[1],
					rampyTiltObject[1],
					rampyRotateObject[1];
			};
			struct {
				a3_DemoSceneObject
					...
					physicsObjects[18];		// physics-aligned
			};
		};
